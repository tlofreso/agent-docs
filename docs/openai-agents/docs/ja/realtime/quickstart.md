...
リアルタイム エージェントは、OpenAI の Realtime API を使って AI エージェントとの音声会話を可能にします。このガイドでは、最初のリアルタイム音声エージェントの作成方法を説明します。

!!! warning "ベータ機能"
Realtime agents はベータ版です。実装の改善に伴い、互換性が崩れる変更が発生する可能性があります。
...
-   `silence_duration_ms`: ターン終端を検出する無音時間
